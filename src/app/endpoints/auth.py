...
REDIRECT_URI = "http://localhost:8000/auth/exchange-token"  # TODO: figure out what this needs to be
...
async def get_auth_url():
    scope = "read,activity:read,activity:read_all"  # TODO: is this everything I need?
    response_type = "code"
